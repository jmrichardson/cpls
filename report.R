...
for (i in 1:length(users)) {
  ...
  # Load template html
  if (users[[i]]$mailIncludePortfolio) {
    users[[i]]$html <- readChar('templates/email_with_portfolio.html', file.info('templates/email_with_portfolio.html')$size)
  } else {
    users[[i]]$html <- readChar('templates/email_no_portfolio.html', file.info('templates/email_no_portfolio.html')$size)
  }
